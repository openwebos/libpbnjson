...
#include "everything_validator.h"
...
static ValidatorVtable everything_vtable =
{
	.check = _check,
};
...
{
	.ref_count = 1,
	.vtable = &everything_vtable,
};

Validator *EVERYTHING_VALIDATOR = &EVERYTHING_VALIDATOR_IMPL;
